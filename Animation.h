...
const Animation manAnimatorLeft(manAnimLeft, 300, COLOUR::FG_DARK_GREY);
const Animation manAnimatorRight(manAnimRight, 300, COLOUR::FG_DARK_GREY);
...
const Animation mainCharLeft(mainAnimLeft, 200, COLOUR::FG_BLACK);
const Animation mainCharRight(mainAnimRight, 200, COLOUR::FG_BLACK);
#endif // !_ANIMATION_
